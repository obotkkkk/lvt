...
extends TaskPasteSchematicPerChunkCommand {
    ...
    protected void sendCommand(String command, class_746 player) {
        ...
        try {
            ...
            Litematica.LOGGER.error("Exception while writing paste commands to file", (Throwable)e);
            this.phase = TaskProcessChunkMultiPhase.TaskPhase.FINISHED;
            this.finished = true;
        }
    }
