...
extends TaskProcessChunkBase {
    ...
    protected boolean executeMultiPhase(class_3695 profiler) {
        long currentTime;
        long elapsedTickTime;
        profiler.method_15396("chunk_multi_phase");
        ...
        while (this.sentCommandsThisTick < this.maxCommandsPerTick && (this.sentCommandsThisTick > commandsLast || this.processedChunksThisTick != processedChunksLast) && (elapsedTickTime = (currentTime = class_156.method_648()) - this.taskStartTimeForCurrentTick) < 25000000L) {
    ...
    protected boolean checkCommandFeedbackGameRuleState(class_2561 message) {
        ...
        if (this.isInWorld() && message instanceof class_5250 && (class_74172 = (mutableText = (class_5250)message).method_10851()) instanceof class_2588 && "commands.gamerule.query".equals((text = (class_2588)class_74172).method_11022())) {
    ...
    protected void sendCommand(String cmd) {
        this.sendCommand(cmd, this.mc.field_1724);
    }
