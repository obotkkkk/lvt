...
ICompletionListener {
    ...
    public GuiSchematicProjectManager(SchematicProject project) {
        ...
        this.title = StringUtils.translate((String)"litematica.gui.title.schematic_project_manager", (Object[])new Object[0]);
    }
    ...
    implements IButtonActionListener {
        ...
        public void actionPerformedWithButton(ButtonBase button, int mouseButton) {
            if (this.type == Type.OPEN_PROJECT_BROWSER) {
                ...
                GuiConfirmAction gui = new GuiConfirmAction(320, title, (IConfirmationListener)executor, (class_437)this.gui, msg, new Object[0]);
                GuiBase.openGui((class_437)gui);
                ...
                if (project != null) {
                    project.setOrigin(PositionUtils.getEntityBlockPos((class_1297)this.gui.mc.field_1724));
